...
class General(commands.Cog):
    ...
    async def info(self, ctx):
        ...
        infoEmbed.add_field(name="Credits", value="Developed by <@!402954494406819862> with invaluable help from the amazing volunteers at the Pythonista Guild.\n\n(Visuals by <@!454041644912738324>)", inline=False)
