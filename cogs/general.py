...
class General(commands.Cog):
    ...
    async def info(self, ctx):
        ...
        infoEmbed.add_field(name="Links", value="[Support Server](https://discord.gg/fmPTwfw) | [Invite!](https://discord.com/api/oauth2/authorize?client_id=732712093756948579&permissions=8&scope=bot) | [GitHub](https://github.com/lixitrixi/Arpeggio)")
